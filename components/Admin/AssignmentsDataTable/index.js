...
export default function EnhancedTable({title}) {
  ...
  const getAllUsers = () => {
    ...
    if(router.pathname === '/assignments'){
      getPosts().then(res => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                       ...
                       {/* {isAuthenticated() && isAuthenticated().user.admin && router.pathname !== '/assignments' && <Link href={`/user/${row._id}/edit`}>
                          <a style={{
                            background: '#fff',
                            color: 'green',
                       ...
                       {isAuthenticated() && isAuthenticated().user.admin && router.pathname !== '/assignments' && <button style={{
                            background: '#fff',
                            color: '#D01B59',
